...
#data1a <- read.table(data1$Summary, sep = "Date/Time", as.is = TRUE)


#data1a <- cSplit(data1, 'Summary', sep="Date/Time", type.convert=FALSE)

#data1a <- str_split(data1$Summary, "1234Z", 2)
# TimeSplit1 <- str_split_fixed(data1$Summary, "Date/Time:", 2)
# vec <- c(TimeSplit1[1], TimeSplit1[2])
# as.list(vec)
# typeof(vec)
# typeof(data1)
