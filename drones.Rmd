...
```{r combdata, include=FALSE}
pop_data <- read_excel("data/Pop_Data/nst-est2019-01.xlsx")
names(pop_data)[1] <- "State"
names(pop_data)[2] <- "Population"


dataReg1 <- read_excel("data/Registrations_Data/Registrations-City-State-Country-Count-2015Q4-2018Q3.xlsx")
...
dataReg2 <- read_excel("data/Registrations_Data/Registrations-City-State-Country-Count-2019Q1.xlsx")
...
dataReg3 <- read_excel("data/Registrations_Data/Registrations-City-State-Country-Count-2019Q2.xlsx")
...
dataReg4 <- read_excel("data/Registrations_Data/Registrations-City-State-Country-Count-2019Q3.xlsx")
